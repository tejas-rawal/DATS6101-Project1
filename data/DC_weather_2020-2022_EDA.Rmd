...
I was curious to see that one can download, without creating an account, weather data from NOAA. One does need to submit a request (it uses a shopping cart convention, though the data are free) and provide an email address; a link will be emailed within a few minutes, depending on the volume of requests. 
...
```{r, results="asis"}
DCweath <- data.frame(read.csv("3089711.csv"))
str(DCweath)                      
